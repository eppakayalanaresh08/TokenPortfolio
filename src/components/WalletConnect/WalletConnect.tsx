  ...
  if (isConnected && address) {
    return (
      <div className="flex items-center gap-3">
        {/* Wallet Info */}
        <div className="flex items-center gap-3 bg-[#ffffff0a] rounded-lg px-4 py-2 border border-[#ffffff14]">
          {/* Balance */}
          ...
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 bg-[#a9e851] rounded-full"></div>
            <button
        ...
        <Button
          ...
          variant="ghost"
          size="sm"
          className="text-zinc-400 hover:text-white hover:bg-[#ffffff0a] px-3 py-2"
        >
